...
class ScenarioRouteTests(unittest.TestCase):
    ...
    def test_cache_busts_scenario_assets(self):
        self.assertIn("kyoukai-building-data.js?v=routee4", self.main_py)
        self.assertIn("kyoukai-scenario-events.js?v=routee4", self.main_py)
        self.assertIn("kyoukai-scenario.js?v=routee4", self.main_py)
