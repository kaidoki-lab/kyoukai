(function () {
  ...
  style.textContent = [
    ...
    "  8%  {opacity:0.94;transform:scaleY(1);    background:#b8cfe0}",
    "  60% {opacity:1;   transform:scaleY(0.01); background:#b8cfe0}",
    "  67% {opacity:1;   transform:scaleY(0.01); background:#000}",
    "  76% {opacity:1;   transform:scaleY(1);    background:#000}",
