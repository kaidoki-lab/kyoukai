...
BASE = r"C:\Users\pc\Documents\Claude\Projects\kyoukai\booth\all-packs"
...
def bundle_readme_txt():
    room_lines = '\n'.join([f"    {r['name']}　　── {r['brb_bottom']}" for r in ROOMS])
    return f"""━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        for room in ROOMS:
            ...
            for dirpath, dirnames, filenames in os.walk(pack_dir):
                for fn in filenames:
                    ...
                    zf.write(fp, arcname)
        zf.writestr("README.txt", bundle_readme_txt())
